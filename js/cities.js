var activeCities = [
    ...
    {coords: [43.443579, 39.910369], name: 'Адлер'},
    ...
    //
    {coords: [55.796339, 37.938199], name: 'Балашиха'},
    {coords: [56.909642, 60.818128], name: 'Берёзовский'},
    {coords: [50.290658, 127.527173], name: 'Благовещенск'},
    {coords: [44.781528, 44.165024], name: 'Будённовск'},
    {coords: [49.089753, 140.255376], name: 'пгт Ванино'},
    {coords: [57.683819, 63.057664], name: 'Ирбит'},
    {coords: [46.633754, 142.780297], name: 'Корсаков'},
    {coords: [48.693682, 45.199228], name: 'Ленинск'},
    {coords: [56.436990, 59.113808], name: 'Михайловск'},
    {coords: [55.910503, 37.736330], name: 'Мытищи'},
    {coords: [52.970143, 36.063397], name: 'Орёл'},
    {coords: [55.888796, 37.430328], name: 'Химки'},
    {coords: [54.002146, 37.517626], name: 'Щёкино'},
    {coords: [44.065632, 39.128368], name: 'пос. Южный'},
    // {coords: [], name: ''},
];
...
var openCities = [
    ...
    //
    {coords: [64.539393, 40.516939], name: 'Архангельск'},
    {coords: [46.347869, 48.033574], name: 'Астрахань'},
    {coords: [68.969582, 33.074558], name: 'Мурманск'},
    {coords: [46.475177, 41.541135], name: 'Сальск'},
    {coords: [47.708485, 40.215958], name: 'Шахты'},
    // {coords: [], name: ''},
];
...
var newCities = [
    ...
    //
    {coords: [47.112129, 39.423267], name: 'Азов'},
    {coords: [50.234524, 136.879148], name: 'Амурск'},
    {coords: [43.350116, 132.159633], name: 'Артём'},
    {coords: [52.065576, 104.081863], name: 'пгт Большой Луг'},
    {coords: [56.975804, 60.564955], name: 'Верхняя Пышма'},
    {coords: [42.726822, 133.081268], name: 'пос. Врангель'},
    {coords: [56.698463, 60.086674], name: 'Дегтярск'},
    {coords: [56.814887, 61.320636], name: 'Заречный'},
    {coords: [44.609764, 40.100516], name: 'Майкоп'},
    {coords: [49.745986, 142.835265], name: 'пгт Смирных'},
    {coords: [61.370744, 63.566784], name: 'Советский'},
    {coords: [56.991837, 60.477136], name: 'Среднеуральск'},
    {coords: [43.797273, 131.951780], name: 'Уссурийск'},
    {coords: [52.824383, 156.282461], name: 'село Усть-Большерецк'},
    {coords: [51.137086, 133.033675], name: 'пгт Чегдомын'},
    // {coords: [], name: ''},
];
